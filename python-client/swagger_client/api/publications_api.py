...
class PublicationsApi(object):
    ...
    def publications_list(self, **kwargs):  # noqa: E501
        ...
        >>> thread = api.publications_list(async_req=True)
        >>> result = thread.get()
    ...
    def publications_list_with_http_info(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.publications_list_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def publications_read(self, id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.publications_read(id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param int id: A unique integer value identifying this publication. (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def publications_read_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.publications_read_with_http_info(id, async_req=True)
        >>> result = thread.get()
